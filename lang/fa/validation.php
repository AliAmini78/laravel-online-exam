...
return [
    ...
    */
    ...
    'required_with' => 'تکمیل گزینه :attribute زمانی که مقدار :values مقداردهی شده است الزامی است',
    'required_with_all' => 'تکمیل گزینه :attribute زمانی که مقادیر :values مقداردهی شده است الزامی می باشد',
    'required_without' => 'تکمیل گزینه :attribute زمانی که مقدار :values مقداردهی شده نیست الزامی است',
    'required_without_all' => 'تکمیل گزینه :attribute زمانی که هیچ کدام از مقادیر :values مقداردهی شده نیست الزامی است',
    ...
    'invalid_question'=>'یک یا چند سوال نامعتبر وجود دارد',
    ...
    */
    ...
    'attributes' => [
        ...
        'mobile' => 'شماره موبایل',
        'new_password' => 'پسوورد جدید',
        'old_password' => 'پسوورد قدیمی',
        'code' => 'کد',
        'zip' => 'فایل زیپ',
        'gender' => 'جنسیت',
        'title' => 'عنوان',
        ...
        'slug' => 'آدرس',
        'parameters' => 'پارامتر',
        'template_id' => 'ایدی قالب',
        'role' => 'رول',
        'permissions' => 'پرمیشن',
        'file' => 'فایل',
        'key_words' => 'کلمات کلیدی',
        'fa_name' => 'نام فارسی',
        'view_access_permission' => 'سطح دسترسی پست ها',
        'view_access_ids' => 'شناسه دسترسی بازدید',
        'view_access_ids.*' => 'شناسه دسترسی بازدید',
        'view_access' => 'دسترسی بازدید',
        'view_access.*' => 'دسترسی بازدید',
        'view_access_group' => ' گروه دسترسی بازدید',
        'view_access_group_ids' => 'شناسه گروه دسترسی بازدید',
        'view_access_group_ids.*' => 'شناسه گروه دسترسی بازدید',
        'category_ids' => 'شناسه دسته بندی',
        ...
        "call_type" => "نوع تماس",
        "started_at" => "شروع",
        "queue_duration" => "زمان صف انتظار",
        "voip_number" => "شماره خط",
        "is_increasing" => "افزایش یا کاهش",
        "amount" => "مقدار",
        "numbers" => "شماره ها",
        "origin" => "مبدا",
        "destination" => "مقصد",
        "time" => "زمان",
        "is_forwarding" => "انتقال تماس",
        "price" => "قیمت",
        "credit_minutes" => "دقیقه اعتبار",
        "is_active" => "فعال بودن",
        "location" => "لوکیشن",
        "is_special" => "ویژه بودن",
        "count_limit" => "تعداد محدودیت",
        "compatible" => "ارتباط با پکیچ دیگر",
        "roles_id" => "شناسه نقش ها",
        "roles_id.*" => "شناسه نقش ها",
        "data" => "اطلاعات",
        "picture" => "تصویر",
        "bank_name" => "نام بانک",
        "bill_picture" => "تصویر قبض",
        "degree_picture" => "تصویر مدرک",
        "national_card_picture" => "تصویر کارت ملی",
        "text" => "متن",
        "gateway" => "شماره سامانه",
        "text_type" => "نوع عبارت",
        "landing_type" => "نوع لندینگ",
        "from" => "ورودی",
        "token" => "توکن",
        "user_id" => "شناسه کاربر",
        "grade_id" => "شناسه گرید",
        ...
        "ext" => "شماره داخلی",
        "sound" => "فایل صدا",
        "start_call_answer_time" => "زمان شروع تماس",
        "end_call_answer_time" => "زمان پایان تماس",
        "count" => "تعداد",
        "max_price" => "حداکثر قیمت",
        "percent" => "درصدی",
        "entry_id" => "شناسه شماره مخزن",
        "client_mobile" => "موبایل مشتری",
        "discount_id" => "شناسه تخفیف",
        "packages" => "پکیج ها",
        "card_number" => "شماره کارت",
        "factor_id" => "شناسه فاکتور",
        "receipt_id" => "شناسه پرداخت",
        "serials" => "سریال",
        "today" => "امروز",
        "reservation_date" => "تاریخ رزرو",
        "work_date" => "تاریخ",
        "factor_serial" => "سریال فاکتور",
        "client_id" => "شناسه مشتری",
        "seller" => "فروشندگان",
        "supervisor" => "سوپروایزر ها",
        "chief_supervisor" => "سر سوپروایزر ها",
        "leader" => "سرپرست ها",
        "subject" => "موضوع",
        "first_description" => "توضیحات اولیه",
        "history" => "تاریخچه",
        "diagnosis" => "علائم",
        "full_name" => "نام کامل",
        ...
        "credit" => "اعتبار",
        "credit_transfer_id" => "شناسه انتقال شارژ",
        "origin_grade_id" => "شناسه گرید مبدا",
        "destination_grade_id" => "شناسه گرید مقسد",
        "rules" => "قوانین",
        "sms" => "اس ام اس",
        "exam_id" => "شناسه آزمون",
        "is_required" => "اجباری بودن",
        "min_answer" => "حداقل جواب",
        "max_answer" => "حداکثر جواب",
        "question_id" => "شناسه سوال",
        "is_true" => "صحیح بودن",
        "supervisor_id" => "شناسه سوپروایزر",
        "seller_groups" => "گروه فروش",
        "user_violation_id" => "شناسه تخلف کاربر",
        "sales" => "فروشنده",
        "organizer" => "برگزار کننده",
        "reject_description" => "دلیل رد شدن",
        "rejected" => " رد شده",
        "answer" => "پاسخ",
        "national_code" => "کدملی",
        "staff" => "کارمند",
